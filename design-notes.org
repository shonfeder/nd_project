...
proof, the user must find a way of "thickening" the twig. This can only be done
by showing how the consequent of the conclusion formula can be derived from the
posited assumption:
